...
! function($) {
    ...
    $.fn.fileuploader = function(q) {
            ...
            var s = $(r),
                ...
                f = {
                    ...
                    redesign: function() {
                        if (o = s, n.theme && p.addClass("fileuploader-theme-" + n.theme), n.changeInput) {
                            switch ((typeof n.changeInput + "").toLowerCase()) {
                                case "boolean":
                                    o = $('<div class="fileuploader-input"><div class="fileuploader-input-button g-btn g-btn_file"><span>' + f._assets.textParse(n.captions.button) + "</span></div></div>");
                                    break;
                                case "string":
                    ...
                    set: function(a, b) {
                        switch (a) {
                            case "attrOpts":
                                var c = ["limit", "maxSize", "fileMaxSize", "extensions", "changeInput", "theme", "addMore", "listInput", "files"];
                                for (var d in c) {
                            ...
                            case "feedback":
                                ...
                                })), $(!o.is(":file")) ? o.find(".fileuploader-input-caption span").html(b) : null;
                                break;
                            case "input":
                    ...
                    onChange: function(a, b) {
                        ...
                        if (f.clipboard._timer && f.clipboard.clean(), !f.isDefaultMode() || (f.reset(), 0 != c.length)) {
                            ...
                            for (var d = 0, e = 0; e < c.length; e++) {
                                ...
                                if (i === !0) n.thumbnails && f.thumbnails.item(h), f.isUploadMode() && f.upload.prepare(h), n.onSelect && $.isFunction(n.onSelect) ? n.onSelect(h, l, p, o, s) : null, d++;
                                else if (f.files.remove(h, !0), i[2] || (f.isDefaultMode() && (f.set("input", ""), f.reset(), i[3] = !0), i[1] ? n.dialogs.alert(i[1]) : null), i[3]) break
                            }
                    ...
                    thumbnails: {
                        ...
                        renderImage: function(a, b) {
                            ...
                            if (a.image = c, "image" == a.format && f.isFileReaderSupported() && (a.appended || n.thumbnails.startImageRenderer || b)) {
                                if (n.thumbnails.synchronImages && (f._pfrL.indexOf(a) != -1 || b ? null : f._pfrL.push(a), f._pfrL.length > 1 && !b)) return;
                        ...
                        send: function(a, b) {
                            if (a.upload) {
                                ...
                                if (n.upload.synchron)
                                    if (a.upload.status = "pending", a.html && c(), b) f._pfuL.indexOf(a) > -1 ? f._pfuL.splice(f._pfuL.indexOf(a), 1) : null;
                                    else if (f._pfuL.indexOf(a) == -1 ? f._pfuL.push(a) : null, f._pfuL.length > 1) return;
                                if (n.upload.beforeSend && $.isFunction(n.upload.beforeSend) && n.upload.beforeSend(a, l, p, o, s) === !1) return c(), void d();
                                ...
                                a.upload.data = a.upload.formData, a.upload.xhr = function() {
                                    ...
                                    a.uploaded = !0, delete a.upload, a.upload = {
                                        status: "successful"
                                    }, a.html && c(), f.set("listInput", null), null != n.upload.onSuccess && $.isFunction(n.upload.onSuccess) ? n.upload.onSuccess(b, a, l, p, o, s, d, e) : null
                            ...
                            if (f._assets.isIntoView(o) && a.originalEvent.clipboardData && a.originalEvent.clipboardData.items && a.originalEvent.clipboardData.items.length) {
                                ...
                                for (var c = 0; c < b.length; c++)
                                    if (b[c].type.indexOf("image") !== -1 || b[c].type.indexOf("text/uri-list") !== -1) {
                                        ...
                                        d && (d.name = "Clipboard " + e.getFullYear() + "-" + g(e.getMonth() + 1) + "-" + g(e.getDate()) + " " + g(e.getHours()) + "-" + g(e.getMinutes()) + "-" + g(e.getSeconds()), d.name += d.type.indexOf("/") != -1 ? "." + d.type.split("/")[1].toString().toLowerCase() : ".png", f.set("feedback", f._assets.textParse(n.captions.paste, {
                                            ms: h / 1e3
                    ...
                    files: {
                        ...
                        check: function(a, b, c) {
                            ...
                            if (null != n.extensions && $.inArray(a.extension, n.extensions) == -1 && $.inArray(a.type, n.extensions) == -1) return d[1] = f._assets.textParse(n.captions.errors.filesType, a), d;
                        ...
                        append: function(a) {
                            if (a = $.isArray(a) ? a : [a], a.length) {
                                for (var b, c = 0; c < a.length; c++) b = f._itFl[f.files.add(a[c], "appended")], n.thumbnails ? f.thumbnails.item(b) : null;
        ...
        captions: {
            button: function(a) {
                return "Добавить " + (1 == a.limit ? "файл" : "файлы")
            },
            feedback: function(a) {
                return "Добавить " + (1 == a.limit ? "файл" : "файлы") + " к списку"
            },
...
Yadadya.DOMReady(function(){
	...
	if (Yadadya.params.isDesctop.matches)
		// $("#video-wrapper").append('<video id="video" width="100%" height="auto" autoplay="autoplay" loop="loop" preload="auto"><source src="/assets/coding-fd2170970d335a6104b1d88364c91f9ddb3a167cf2c5726a1ba5cd4d367cc250.webm" type="video/webm"></source></video>');
	var tiltSettings = {
				movement: {
					imgWrapper : {
